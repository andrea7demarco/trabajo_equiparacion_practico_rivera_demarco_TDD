...
Una ventaja central de su aplicación es la **generación de una suite de pruebas de regresión** que se generan sistemáticamente debido a la misma especificación de TDD. Esta suite brinda a los desarrolladores un mayor nivel de confianza al realizar modificaciones o refactorizaciones, reduciendo el riesgo percibido de introducir errores inadvertidos.
...
Puede notarse que en ningún momento **TDD garantiza un aumento en la calidad del software**. Si bien se habla de un nivel más de calidad tras su aplicación, esta información está basada en datos empíricos extraídos de mediciones en proyectos de distintas escalas, distintos propósitos y desarrollados por distintos equipos, con mediciones basadas en distintos factores, e incluso en algunos casos imprecisa, pues se tiende a no contemplar el proceso de test y debugging como parte del proceso de desarrollo.

⬅️ [Volver a las distintas direcciones](../README.md) | [Siguiente](05-limitaciones.md/) ➡️
